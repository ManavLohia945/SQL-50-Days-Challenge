...
--A returning active user is a user that has made a second purchase within 7 days of their first purchase. Output a list of user_ids of these returning active users.
...
----------SO MUCH WASTE OF SPACE 259 ENTRIES
SELECT 
