...
INSERT INTO Employees11 (Emp_No, Emp_Name, Job_Name, Manager_Id, HireDate, Salary, Commission, DeptNo) VALUES
...
SELECT e1.emp_no, 
	   ...
	   COALESCE(e2.emp_name,'No Boss') AS immediate_manager
FROM Employees11 as e1
LEFT JOIN Employees11 as e2
